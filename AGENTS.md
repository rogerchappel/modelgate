# Agent Operating Instructions for modelgate

This file defines how AI agents and human maintainers should work in `modelgate`.

## Project Context

- Project: `modelgate`
- Repository: `rogerchappel/modelgate`
